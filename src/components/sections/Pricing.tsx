...
const plans = [
  {
    name: 'Стандарт',
    price: '15 000',
    desc: 'Для деловых поездок',
    features: ['Бизнес-класс авто', 'Страховка ОСАГО', 'Пробег 200 км/сут', 'Поддержка в рабочее время'],
    featured: false,
  },
  {
    name: 'Премиум',
  ...
  },
  {
    ...
    features: [
      'Топовые модели',
      'Полная страховка + Персона',
      'Личный водитель по запросу',
